...
from .dag import Dag
from .environment import REFRESH_INTERVAL_IN_SECONDS, POD_NAMESPACE, INSTANCE_ID
from .globals import max_id, pod_name_job, job_id_job, _log_path, _read_file, batch_id_batch
from .globals import next_id, dag_id_dag
from .job import Job
...
def create_job():
    ...
    pod_spec = v1.api_client._ApiClient__deserialize(
        parameters['pod_spec'], kube.client.V1PodSpec)
